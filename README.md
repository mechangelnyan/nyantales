...
**Testing:** 204 unit tests (Node.js) + 238 Playwright browser tests covering UI, a11y, persistence, deep links, campaign flow, engine logic, manifest/lazy-loading, and production builds. Run `npm test` and `npx playwright test`.
...
│   └── web/
│       └── vn.spec.js      238 Playwright browser tests for the web VN
├── package.json
└── README.md
```
